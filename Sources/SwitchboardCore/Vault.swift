...
public final class Vault: Sendable {
    ...
    public static let keychainService = "Switchboard"
    ...
    public static var defaultRoot: URL {
        ...
        return support.appendingPathComponent("Switchboard", isDirectory: true)
    }
    ...
    /// Keychain entries left behind by accounts no longer on the roster — the
    /// result of a removal that failed halfway, or of a roster restored from an
    /// older backup.
