...
/// A directory Switchboard is allowed to clear.
///
...
public struct CacheEntry: Identifiable, Hashable {
    ...
    /// True when clearing it under a running owner is harmless — staging areas
    /// an app reads only at update time, rather than caches it holds open.
